        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="view-blogs.php">View blogs</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Delete blog</a>
              </li>
            </ul>
            <form class="d-flex">
          ...
          try {
              ...
              foreach($result as $row) {
                  ...
                  <div class="blog mb-3 p-3 bg-light text-dark">
                    <div class="upper-part d-flex justify-content-between">
                      <div class="blog-title-area h4 d-flex">
                        <div class="blog-id">'. $row['blog_id'] .'.&nbsp;</div>
                        <div class="blog-title">'. $row['blog_title'] .'</div>
                      </div>
                      <div class="delete">
                        <a href="delete.php?id='. $row['blog_id'] .'"><i class="fa-solid fa-trash-can text-dark"></i></a>
                      </div>
                    </div>
